      ...
      <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 rounded-2xl border border-neutral-800 bg-neutral-900/50 p-4">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1 rounded-xl border border-neutral-700 bg-neutral-950 px-4 py-3 font-mono text-lg text-white min-h-[52px] break-all">
              {password || (
